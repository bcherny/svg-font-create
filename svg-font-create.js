...
var DOMParser, SvgPath, config, convert, cssTemplate, defaults, execSync, fs, generate, glob, htmlTemplate, parse, path, phantomTemplate, rgxAcronym, rgxName, rgxUnicode, sassTemplate, svgTemplate, util, webshot, _;
...
generate = function(data) {
  ...
  return _.forEach({
    ...
    'Generating PNG spec': function() {
      ...
      return webshot(phantomTemplate(data), './dist/font.png', {
        renderDelay: 2000,
        siteType: 'html'
      }, function(err) {
        throw new Error(err);
